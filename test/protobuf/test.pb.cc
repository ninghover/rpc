...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::UserList, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::UserList, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::UserList, _impl_.friends_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginRequest, _impl_.age_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 17, -1, -1, sizeof(::fixbug::UserList)},
  { 25, -1, -1, sizeof(::fixbug::LoginRequest)},
  { 33, -1, -1, sizeof(::fixbug::LoginResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::fixbug::_ResultCode_default_instance_._instance,
  &::fixbug::_User_default_instance_._instance,
  &::fixbug::_UserList_default_instance_._instance,
...
class UserList::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const UserList* msg);
};

const ::fixbug::ResultCode&
UserList::_Internal::result(const UserList* msg) {
...
UserList::UserList(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.UserList)
}
UserList::UserList(const UserList& from)
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.UserList)
}
...
UserList::~UserList() {
  // @@protoc_insertion_point(destructor:fixbug.UserList)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void UserList::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.UserList)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* UserList::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.UserList)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.UserList)
  return target;
}

size_t UserList::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.UserList)
  size_t total_size = 0;
...
void UserList::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.UserList)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.UserList)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::fixbug::UserList*
Arena::CreateMaybeMessage< ::fixbug::UserList >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::UserList >(arena);
}
