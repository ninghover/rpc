...
class GetFriendListResonse;
struct GetFriendListResonseDefaultTypeInternal;
extern GetFriendListResonseDefaultTypeInternal _GetFriendListResonse_default_instance_;
class ResultCode;
...
template<> ::fixbug::GetFriendListResonse* Arena::CreateMaybeMessage<::fixbug::GetFriendListResonse>(Arena*);
...
class GetFriendListResonse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListResonse) */ {
 public:
  inline GetFriendListResonse() : GetFriendListResonse(nullptr) {}
  ~GetFriendListResonse() override;
  explicit PROTOBUF_CONSTEXPR GetFriendListResonse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendListResonse(const GetFriendListResonse& from);
  GetFriendListResonse(GetFriendListResonse&& from) noexcept
    : GetFriendListResonse() {
    *this = ::std::move(from);
  }

  inline GetFriendListResonse& operator=(const GetFriendListResonse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListResonse& operator=(GetFriendListResonse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendListResonse& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendListResonse* internal_default_instance() {
    return reinterpret_cast<const GetFriendListResonse*>(
               &_GetFriendListResonse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetFriendListResonse& a, GetFriendListResonse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListResonse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendListResonse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendListResonse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendListResonse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendListResonse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetFriendListResonse& from) {
    GetFriendListResonse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListResonse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListResonse";
  }
  protected:
  explicit GetFriendListResonse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListResonse)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListResonse::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool GetFriendListResonse::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListResonse::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListResonse::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFriendListResonse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResonse.result)
  return _internal_result();
}
inline void GetFriendListResonse::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListResonse.result)
}
inline ::fixbug::ResultCode* GetFriendListResonse::release_result() {
...
inline ::fixbug::ResultCode* GetFriendListResonse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListResonse.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListResonse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListResonse::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResonse.result)
  return _msg;
}
inline void GetFriendListResonse::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListResonse.result)
}

// repeated bytes friends = 2;
inline int GetFriendListResonse::_internal_friends_size() const {
  return _impl_.friends_.size();
}
inline int GetFriendListResonse::friends_size() const {
  return _internal_friends_size();
}
inline void GetFriendListResonse::clear_friends() {
  _impl_.friends_.Clear();
}
inline std::string* GetFriendListResonse::add_friends() {
  std::string* _s = _internal_add_friends();
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListResonse.friends)
  return _s;
}
inline const std::string& GetFriendListResonse::_internal_friends(int index) const {
  return _impl_.friends_.Get(index);
}
inline const std::string& GetFriendListResonse::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResonse.friends)
  return _internal_friends(index);
}
inline std::string* GetFriendListResonse::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResonse.friends)
  return _impl_.friends_.Mutable(index);
}
inline void GetFriendListResonse::set_friends(int index, const std::string& value) {
  _impl_.friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResonse.friends)
}
inline void GetFriendListResonse::set_friends(int index, std::string&& value) {
  _impl_.friends_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResonse.friends)
}
inline void GetFriendListResonse::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListResonse.friends)
}
inline void GetFriendListResonse::set_friends(int index, const void* value, size_t size) {
  _impl_.friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListResonse.friends)
}
inline std::string* GetFriendListResonse::_internal_add_friends() {
  return _impl_.friends_.Add();
}
inline void GetFriendListResonse::add_friends(const std::string& value) {
  _impl_.friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResonse.friends)
}
inline void GetFriendListResonse::add_friends(std::string&& value) {
  _impl_.friends_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResonse.friends)
}
inline void GetFriendListResonse::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListResonse.friends)
}
inline void GetFriendListResonse::add_friends(const void* value, size_t size) {
  _impl_.friends_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListResonse.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendListResonse::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResonse.friends)
  return _impl_.friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendListResonse::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResonse.friends)
  return &_impl_.friends_;
}
