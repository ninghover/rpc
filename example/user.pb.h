...
inline const std::string& RegisterResponse::success() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.success)
  return _internal_success();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RegisterResponse::set_success(ArgT0&& arg0, ArgT... args) {
 
 _impl_.success_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.RegisterResponse.success)
}
inline std::string* RegisterResponse::mutable_success() {
  std::string* _s = _internal_mutable_success();
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterResponse.success)
  return _s;
}
inline const std::string& RegisterResponse::_internal_success() const {
  return _impl_.success_.Get();
}
inline void RegisterResponse::_internal_set_success(const std::string& value) {
  
  _impl_.success_.Set(value, GetArenaForAllocation());
}
inline std::string* RegisterResponse::_internal_mutable_success() {
  
  return _impl_.success_.Mutable(GetArenaForAllocation());
}
inline std::string* RegisterResponse::release_success() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterResponse.success)
  return _impl_.success_.Release();
}
inline void RegisterResponse::set_allocated_success(std::string* success) {
  if (success != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterResponse.success)
}
