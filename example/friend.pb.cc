...
PROTOBUF_CONSTEXPR GetFriendListResonse::GetFriendListResonse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.friends_)*/{}
  , /*decltype(_impl_.result_)*/nullptr
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct GetFriendListResonseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR GetFriendListResonseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~GetFriendListResonseDefaultTypeInternal() {}
  union {
    GetFriendListResonse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetFriendListResonseDefaultTypeInternal _GetFriendListResonse_default_instance_;
}  // namespace fixbug
...
const uint32_t TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResonse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResonse, _impl_.result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResonse, _impl_.friends_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::fixbug::ResultCode)},
  { 8, -1, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 15, -1, -1, sizeof(::fixbug::GetFriendListResonse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::fixbug::_ResultCode_default_instance_._instance,
  &::fixbug::_GetFriendListRequest_default_instance_._instance,
  &::fixbug::_GetFriendListResonse_default_instance_._instance,
};
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ndListRequest\032\034.fixbug.GetFriendListReso"
...
const ::_pbi::DescriptorTable descriptor_table_friend_2eproto = {
    false, false, 296, descriptor_table_protodef_friend_2eproto,
    "friend.proto",
...
class GetFriendListResonse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListResonse* msg);
};

const ::fixbug::ResultCode&
GetFriendListResonse::_Internal::result(const GetFriendListResonse* msg) {
  return *msg->_impl_.result_;
}
GetFriendListResonse::GetFriendListResonse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendListResonse)
}
GetFriendListResonse::GetFriendListResonse(const GetFriendListResonse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  GetFriendListResonse* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListResonse)
}

inline void GetFriendListResonse::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
GetFriendListResonse::~GetFriendListResonse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListResonse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void GetFriendListResonse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.friends_.~RepeatedPtrField();
  if (this != internal_default_instance()) delete _impl_.result_;
}

void GetFriendListResonse::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void GetFriendListResonse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListResonse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListResonse::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* GetFriendListResonse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListResonse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListResonse)
  return target;
}

size_t GetFriendListResonse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListResonse)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData GetFriendListResonse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    GetFriendListResonse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*GetFriendListResonse::GetClassData() const { return &_class_data_; }


void GetFriendListResonse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<GetFriendListResonse*>(&to_msg);
  auto& from = static_cast<const GetFriendListResonse&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListResonse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListResonse::CopyFrom(const GetFriendListResonse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListResonse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListResonse::IsInitialized() const {
  return true;
}

void GetFriendListResonse::InternalSwap(GetFriendListResonse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListResonse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_friend_2eproto_getter, &descriptor_table_friend_2eproto_once,
    ...
    case 0:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListResonse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFriendListResonse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListResonse*
Arena::CreateMaybeMessage< ::fixbug::GetFriendListResonse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendListResonse >(arena);
}
